...
The Ledger team has adopted a *rolling release model* and supports two stable versions of Ledger.
...
Before the release of the next stable version, feature PRs will be frozen. A release manager will be assigned to major/minor version and will lead the Ledger community in test, bug-fix and documentation of the release for one to two weeks.
...
[master]: https://github.com/danielnegri/tokenapi-go/tree/master
